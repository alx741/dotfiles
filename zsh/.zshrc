...
#{{{ Aliases
    ...
    alias svgo="command svgo --config='{ \"plugins\": [{ \"removeViewBox\": false }, { \"removeDimensions\": true }] }'"
    alias svgoids="command svgo --config='{ \"plugins\": [{ \"removeViewBox\": false }, { \"removeDimensions\": true }, { \"cleanupIDs\": false }] }'"
