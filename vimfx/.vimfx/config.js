...
vimfx.set('mode.normal.scroll_left', '<c-w> <c-h> <space> H')
vimfx.set('mode.normal.scroll_right', '<c-l> L')
...
vimfx.set('mode.normal.history_forward', '<c-n> <c-i>')
vimfx.set('mode.normal.history_back', '<c-p> <c-o>')
